 ...
 */
@Configuration
@MapperScan(basePackages = "com.eqca.repository.mapper.a.*",
...
public class MyBatisConfigA {
    ...
    SqlSessionFactory sqlSessionFactoryA(@Qualifier("dataSourceA") DataSource dataSourceA) throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:mapper/a/**/*.xml"));
